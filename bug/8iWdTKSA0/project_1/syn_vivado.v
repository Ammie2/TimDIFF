...
// Date        : Sun Sep 15 20:12:00 2024
// Host        : user-Super-Server running 64-bit Ubuntu 22.04.4 LTS
// Command     : write_verilog -force /media/user/data/cwz/reduce/shift/t5/995/vivado_995/p1/syn_vivado.v
// Design      : top
...
module top
  ...
  OBUF \y_OBUF[41]_inst 
       (.I(\<const0> ),
        .O(y[41]));
  OBUFT \y_OBUF[42]_inst 
       (.I(\<const0> ),
        .O(y[42]),
        .T(\<const1> ));
  OBUFT \y_OBUF[43]_inst 
       (.I(\<const0> ),
        .O(y[43]),
        .T(\<const1> ));
  OBUFT \y_OBUF[44]_inst 
       (.I(\<const0> ),
        .O(y[44]),
        .T(\<const1> ));
  OBUFT \y_OBUF[45]_inst 
       (.I(\<const0> ),
        .O(y[45]),
        .T(\<const1> ));
  OBUFT \y_OBUF[46]_inst 
       (.I(\<const0> ),
        .O(y[46]),
        .T(\<const1> ));
  OBUF \y_OBUF[4]_inst 
